...
#ifdef CONFIG_ZB_DISABLE_AUTO_REBOOT_FOR_CI
#define DISABLE_AUTO_REBOOT_FOR_CI
#endif
...
/* Declarations needed for RTP_SEC_* tests */
...
#endif /* CONFIG_ZB_STACK_REGRESSION_TESTING_API */
